...
const ValidatedInput = React.forwardRef<HTMLInputElement, ValidatedInputProps>(
  ({ className, validationRule, customValidator, showValidation = true, wrapperClassName, value, ...props }, ref) => {
    ...
    return (
      <>
        ...
        />
        {showCheckmark && (
          <div className={cn("absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none z-10", wrapperClassName)}>
