...
export const OnboardingStep = ({ onContinue }: OnboardingStepProps) => {
  ...
  return (
    <div className="animate-fade-in space-y-4">
      {/* Hero Section */}
      <div
        className="group relative overflow-hidden rounded-3xl bg-foreground min-h-[320px] md:min-h-[360px] touch-pan-y"
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-6 md:p-8">
          <div key={currentSlide} className="animate-fade-in">
            ...
            <p className="text-sm md:text-base text-background/50 max-w-xs">
              {slide.description}
            </p>
          </div>
