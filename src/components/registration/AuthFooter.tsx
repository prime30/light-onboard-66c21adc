...
export function AuthFooter({
  ...
  return (
    <footer
      className={cn(
        "sticky bottom-[10px] mx-[10px] bg-background p-2.5 sm:p-5 lg:px-[25px] lg:py-[clamp(10px,1.5vh,25px)] pb-[max(0.625rem,env(safe-area-inset-bottom))] rounded-full overflow-hidden border border-border/30 shadow-[0_0_20px_-5px_rgba(0,0,0,0.12)]",
