...
export function AuthFooter({
  ...
  // the late create-password page (the last gate before the real submit in
  ...
  const isFinalGateStep = isFinalStep || isSummaryStep || isLatePasswordStep || isFauxSubmitStep;
