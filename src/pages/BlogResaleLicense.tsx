...
const BlogResaleLicense = () => {
  ...
  return (
    <div className="w-full mx-auto max-w-[900px] bg-background overflow-hidden animate-[pageSlideUp_0.5s_cubic-bezier(0.16,1,0.3,1)_forwards] flex flex-col">
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-5 sm:px-8 lg:px-12 py-8">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            ...
            license can save you money and keep your business compliant. Here's everything you need
            to know.
          </p>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                ...
                license) is a document that allows you to purchase products wholesale without paying
                sales tax at the time of purchase. Instead, you collect sales tax from your end
                customers when you sell the products or services.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3 text-foreground/80">
                  <span className="w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" />
                  <span>
                    <strong>Wholesale Access:</strong> Many distributors require a resale license to
                ...
                <li className="flex items-start gap-3 text-foreground/80">
                  <span className="w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" />
                  <span>
                    <strong>Business Legitimacy:</strong> Shows suppliers and clients that you're a
                ...
                <li className="flex items-start gap-3 text-foreground/80">
                  <span className="w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" />
                  <span>
                    <strong>Legal Compliance:</strong> Operating without proper licensing can result
          ...
          <div className="mt-12 pt-8 border-t border-border">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <Link to="/auth" state={{ advanceToStep: "tax-exemption" }}>
