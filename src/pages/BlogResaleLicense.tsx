...
const BlogResaleLicense = () => {
  return (
    <div className="min-h-screen bg-foreground/60 backdrop-blur-sm flex items-start sm:items-center justify-center pt-12 sm:pt-0 px-0 sm:px-4">
      <div className="w-full sm:w-[95vw] lg:w-[90vw] max-w-[900px] h-[calc(100vh-3rem)] sm:h-[90vh] bg-background rounded-t-lg sm:rounded-xl lg:rounded-xl shadow-2xl overflow-hidden animate-[pageSlideUp_0.5s_cubic-bezier(0.16,1,0.3,1)_forwards] flex flex-col">
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="px-5 sm:px-8 lg:px-12 py-8">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              As a professional stylist or salon owner, understanding the importance of a resale
              license can save you money and keep your business compliant. Here's everything you
              need to know.
            </p>
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
              ...
              <section>
                ...
                <p className="text-foreground/80 leading-relaxed">
                  A resale license (also called a reseller's permit, sales tax permit, or wholesale
                  license) is a document that allows you to purchase products wholesale without
                  paying sales tax at the time of purchase. Instead, you collect sales tax from your
                  end customers when you sell the products or services.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-foreground/80">
                    ...
                    <span>
                      <strong>Tax Savings:</strong> Avoid paying sales tax on products you purchase
                      for resale, improving your profit margins.
                    </span>
                  </li>
                  <li className="flex items-start gap-3 text-foreground/80">
                    <span className="w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" />
                    <span>
                      <strong>Wholesale Access:</strong> Many distributors require a resale license
                  ...
                  <li className="flex items-start gap-3 text-foreground/80">
                    <span className="w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" />
                    <span>
                      <strong>Business Legitimacy:</strong> Shows suppliers and clients that you're
                  ...
                  <li className="flex items-start gap-3 text-foreground/80">
                    <span className="w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" />
                    <span>
                      <strong>Legal Compliance:</strong> Operating without proper licensing can
              ...
              <section>
                ...
                <div className="bg-muted/50 border border-border/50 rounded-xl p-5 space-y-4">
                  <div className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-foreground text-background text-sm font-medium flex items-center justify-center shrink-0">
                      1
                    </span>
                    <div>
                      <p className="font-medium">Register your business</p>
                      <p className="text-sm text-muted-foreground">
                        Obtain an EIN and register your business entity with your state.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Visit your state's Department of Revenue website to apply online.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Most states process applications within 1-2 weeks.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-primary/10 border border-primary/20 rounded-xl p-6">
                ...
                <p className="text-foreground/80">
                  Even if you don't have a resale license yet, you can still register with us! Once
                  you obtain your license, simply upload it to your account to unlock tax-exempt
                  purchasing.
                </p>
              </div>
            </div>
