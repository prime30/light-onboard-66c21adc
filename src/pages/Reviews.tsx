...
const Reviews = () => {
  ...
  return (
    <div className="min-h-screen bg-foreground/60 backdrop-blur-sm flex items-start sm:items-center justify-center pt-12 sm:pt-0 px-0 sm:px-4">
      <div className="w-full sm:w-[95vw] lg:w-[90vw] max-w-[1400px] h-[calc(100vh-3rem)] sm:h-[90vh] bg-background rounded-t-lg sm:rounded-xl lg:rounded-xl shadow-2xl overflow-hidden animate-[pageSlideUp_0.5s_cubic-bezier(0.16,1,0.3,1)_forwards] flex flex-col">
        <div className="flex-1 overflow-y-auto px-5 sm:px-8 lg:px-12 py-8">
          ...
          <div className="bg-gradient-to-r from-muted/50 to-transparent border border-border/50 rounded-xl p-6 md:p-8 mb-8">
            ...
            <p className="text-base md:text-lg font-medium leading-relaxed mb-6 text-foreground">
              "This platform has completely transformed how I run my business. The wholesale pricing
              alone has saved me thousands, and the community is incredibly supportive."
            </p>
